...
const seedDataWithoutExit = async () => {
  try {
    ...
    const usersData = [
      { name: 'Alex Chen', email: 'aonedesigner95@gmail.com', password: 'Akshay@95', role: 'admin', status: 'active', country: 'USA' },
    ...
    console.log('  Admin:    aonedesigner95@gmail.com    / Akshay@95');
